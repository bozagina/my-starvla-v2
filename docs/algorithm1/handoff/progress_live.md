...
## [2026-04-11 11:21:15 +08:00] ALG1-FASA-20260411-025-OC Add A-module phase handoff doc set (design/training/gates/results)

- Owner: Codex
- Status: DONE
- Objective:
  - While Phase2.3 long-run is in progress, complete the formal A-module documentation package for phase handoff and next-step execution.
- Changes:
  - Files:
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_design.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_training_guide.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_acceptance_gates.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_results_and_innovation.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/README.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/progress_live.md`
  - Code/Config summary:
    - Added architecture-level contract doc for standalone A-module (`a_outputs`) including strict shape policy and replacement strategy.
    - Added runnable training guide with standalone strict-mode command template, run directory rule, and troubleshooting.
    - Added acceptance gate spec covering G0-G6 from data contract to full eval go/no-go.
    - Added evidence-based results/innovation note consolidating 018/021/022 outcomes and PR traceability.
    - Updated handoff README index to include new A-module docs.
- Evidence:
  - Commands:
    - `rg -n "a_loss_risk|a_loss_trigger|a_loss_embed|corrective_loss_delta|corrective_loss_region" /Users/bazinga/code/my-starvla-v2/starVLA/model/framework/QwenPI.py`
    - `rg -n "standalone|strict_missing|fallback_to_lite|strict_output_contract" /Users/bazinga/code/my-starvla-v2/starVLA/model/framework/a_module_interface.py`
    - `rg -n "loss/risk|loss/trigger|loss/delta|loss/region|loss/embed" /Users/bazinga/code/my-starvla-v2/starVLA/training/train_starvla.py`
    - `cat /Users/bazinga/code/my-starvla-v2/_remote_runs/p4_1_fasa_phase2_1b_nonzero_gate_20260410/p4_1_fasa_phase2_1b_nonzero_gate_20260410_20260410_183106__ALG1-FASA-20260410-018-OC/train_500/metrics_key_summary.json`
    - `cat /Users/bazinga/code/my-starvla-v2__postmerge_validate_20260410/_remote_runs/p4_1_fasa_phase2_2_postmerge_validate_20260410/p4_1_fasa_phase2_2_postmerge_validate_20260410_20260410_222951__ALG1-FASA-20260410-021-OC/eval_smoke_summary.json`
    - `cat /Users/bazinga/code/my-starvla-v2__postmerge_validate_20260410/_remote_runs/p4_1_fasa_phase2_2_evalfix_20260411/p4_1_fasa_phase2_2_evalfix_20260411_20260411_061822__ALG1-FASA-20260411-022-OC/eval_smoke_summary.json`
  - Key outputs/metrics:
    - 018: `train_50/train_500 all_loss_finite=true`, decomposed non-zero gate pass, freeze/noise gate pass.
    - 021: eval smoke blocked by multi-image payload shape mismatch.
    - 022: eval smoke pass=true after image payload handling fix.
- Decision:
  - Documentation package is now ready for engineering handoff while 5k run continues.
- Risks/Notes:
  - Phase2.3 long-run final acceptance remains pending runtime completion and full evaluation.
- Next step:
  - After 5k completion, append final metrics and go/no-go decision into `a_module_results_and_innovation.md`.
- Commit message:
  - `[ALG1-FASA-20260411-025-OC] add A-module design/training/gates/results docs for Phase2 handoff`

## [2026-04-11 22:41:12 +08:00] ALG1-FASA-20260411-026-OC Add newcomer-facing pseudo-label and A-module full guide

- Owner: Codex
- Status: DONE
- Objective:
  - Create a single newcomer-facing document that explains historical and current pseudo-label systems, construction pipeline, A-module sidecar evolution, and training consumption path end-to-end.
- Changes:
  - Files:
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_newcomer_guide.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/README.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/progress_live.md`
  - Code/Config summary:
    - Added an integrated onboarding doc for non-project readers.
    - Documented prior vs current pseudo-label fields and construction formulas.
    - Documented upgrades from pseudo-label-only supervision to `region_target_15` + sidecar `a_outputs` contract.
    - Clarified current state: standalone A-module consumes external `a_outputs`; VDPM is not online-integrated in main training path.
    - Added the new onboarding doc to handoff index.
- Evidence:
  - Commands:
    - `nl -ba /Users/bazinga/code/my-starvla-v2/tools/build_fasa_dataset.py | sed -n '78,140p'`
    - `nl -ba /Users/bazinga/code/my-starvla-v2/starVLA/model/framework/optional_loss_utils.py | sed -n '44,140p'`
    - `nl -ba /Users/bazinga/code/my-starvla-v2/tools/build_fasa_a_outputs.py | sed -n '168,240p'`
    - `nl -ba /Users/bazinga/code/my-starvla-v2/starVLA/model/framework/a_module_interface.py | sed -n '330,378p'`
    - `nl -ba /Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/progress_live.md | sed -n '5834,5874p'`
  - Key outputs/metrics:
    - Verified pseudo-label builder computes `{trigger_label, risk_score, affected_region_prior, correction_mask, delta_action_norm}` from action chunk deltas.
    - Verified current optional target parser supports sequence-form `delta_action_norm` via max finite reduction.
    - Verified sidecar `a_outputs` builder exports frozen 7-field contract with fallback tracing.
    - Verified A-module interface mode switch remains `lite|standalone`, with standalone reading external payload.
- Decision:
  - Newcomer guide is now the single recommended entrypoint for understanding pseudo-label and A-module data semantics before running experiments.
- Risks/Notes:
  - The guide reflects current mainline code semantics; if contract fields change in future, this doc must be updated in lockstep.
- Next step:
  - After current 5k run completes, append run-specific evidence and decision into the results doc and cross-link from newcomer guide if semantics change.
- Commit message:
  - `[ALG1-FASA-20260411-026-OC] add newcomer full guide for pseudo-label and A-module data pipeline`

## [2026-04-11 22:47:02 +08:00] ALG1-FASA-20260411-027-OC Normalize A-module docs to server absolute path convention

- Owner: Codex
- Status: DONE
- Objective:
  - Update newly added A-module documentation set so that absolute file paths follow server workspace convention rather than local desktop paths.
- Changes:
  - Files:
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_design.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_training_guide.md`
    ...
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/progress_live.md`
  - Code/Config summary:
    - Replaced `/Users/bazinga/code/my-starvla-v2` prefix with `/2025233147/zzq/SpatialVLA_llava3d/starvla_test_qwen/starVLA` in the A-module document package and index.
- Evidence:
  - Commands:
    - `perl -pi -e 's#/Users/bazinga/code/my-starvla-v2#/2025233147/zzq/SpatialVLA_llava3d/starvla_test_qwen/starVLA#g' <A-module docs + README>`
    - `rg -n "/Users/bazinga/code/my-starvla-v2" <A-module docs + README>`
  - Key outputs/metrics:
    - no remaining local desktop path hits in the updated A-module docs/index.
- Decision:
  - Keep server-path convention as authoritative for operator-facing docs.
- Risks/Notes:
  - Historical entries in `progress_live.md` preserve original logged paths by design (append-only log policy).
- Next step:
  - Continue appending evidence using server-path references for all new A-module documentation updates.
- Commit message:
  - `[ALG1-FASA-20260411-027-OC] normalize A-module docs to server absolute path convention`

## [2026-04-11 22:50:24 +08:00] ALG1-FASA-20260411-028-OC Fix malformed server path suffix in A-module docs

- Owner: Codex
- Status: DONE
- Objective:
  - Correct malformed server paths introduced by bulk replacement (`starVLA__postmerge_validate_20260410`) so all A-module docs use canonical server repo root.
- Changes:
  - Files:
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_training_guide.md`
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_acceptance_gates.md`
    ...
    - `/Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/progress_live.md`
  - Code/Config summary:
    - Replaced `.../starVLA__postmerge_validate_20260410/...` with canonical `.../starVLA/...` path form in A-module docs.
- Evidence:
  - Commands:
    - `perl -pi -e 's#.../starVLA__postmerge_validate_20260410#.../starVLA#g' <affected docs>`
    - `rg -n "__postmerge|/Users/bazinga/code/my-starvla-v2" /Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/a_module_*.md /Users/bazinga/code/my-starvla-v2/docs/algorithm1/handoff/README.md -S`
  - Key outputs/metrics:
    - no malformed postmerge suffix and no local desktop path remains in A-module docs/index.
- Decision:
  - A-module docs now consistently follow server path convention.
- Next step:
