...
4. `<REPO_ROOT>/docs/starvla_retrofit/handoff/threads/thread_t2_schema_infra.md`
5. `<REPO_ROOT>/docs/starvla_retrofit/handoff/threads/thread_t1_data_builder.md`

## 3) 白名单文件

1. `<REPO_ROOT>/tools/handoff/*.py`
2. `<REPO_ROOT>/docs/starvla_retrofit/handoff/*.md`
3. `<REPO_ROOT>/docs/starvla_retrofit/handoff/threads/*.md`
