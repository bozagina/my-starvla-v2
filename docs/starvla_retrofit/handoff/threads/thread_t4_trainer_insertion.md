...
5. `<REPO_ROOT>/docs/starvla_retrofit/handoff/threads/thread_t1_data_builder.md`

## 3) 白名单文件

1. `<REPO_ROOT>/starVLA/training/train_starvla.py`
2. `<REPO_ROOT>/starVLA/model/framework/QwenPI.py`
3. `<REPO_ROOT>/starVLA/model/framework/QwenGR00T.py`
4. `<REPO_ROOT>/starVLA/model/framework/QwenAdapter.py`
5. `<REPO_ROOT>/starVLA/model/modules/vlm/QWen2_5.py`
6. `<REPO_ROOT>/starVLA/model/modules/vlm/QWen3.py`
7. `<REPO_ROOT>/starVLA/config/training/*.yaml`
8. `<REPO_ROOT>/docs/starvla_retrofit/handoff/*.md`
