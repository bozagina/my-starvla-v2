...
# NOTE(ALG1-FASA-20260412-031-OC):
# This script is migrated from the historical run artifact:
# /2025233147/zzq_0317/codex_runs/p4_1_fasa_phase0_libero_remote_20260409/tools/build_fasa_dataset.py
# to make the FASA dataset builder a tracked repository tool again.
