...
###############################################################################
# CP-AH-4 Baseline Training
#
# From 30k pre-trained QwenPI checkpoint, trains with A-module (lite mode)
# + corrective_loss but WITHOUT CorrectiveFlowHead.
...
RUN_ID="cp_ah4_baseline_3k_$(date +%Y%m%d_%H%M%S)"
...
echo "=== CP-AH-4 Baseline Training (A-module only, NO corrective flow) ==="
echo "RUN_ID: ${RUN_ID}"
